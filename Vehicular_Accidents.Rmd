...
Graph 20: Relationship between Age and Time of Day When Accidents Occur
...
Plot 38: Ridge plot of Age distribution by Injury Severity
...
Plot 39: Bar plot of Number of Accidents by Vehicle Body Type, faceted by Alcohol Involvement
```{r Plot39, fig.cap="Bar plot showing the number of accidents by vehicle body type, faceted by alcohol involvement."}
ggplot(data = Names_Changed, aes(x = Vehicle_body_type)) +
  geom_bar() +
...
# MwStatistics(Names_Changed, "Datetime", "Number_of_vehicles_involved", "Number_of_persons_involved", win = 100, stat = "Correlation", overlap = 0.5, genplot = TRUE, genDataFrame = TRUE, timeType = "POSIXct")
