...
- Information Captured: Date/time, intoxication, injury severity, location
- Data Cleaning and Manipulation Steps:
    - Column names modified for readability
    - Numeric values converted to text for consistency
...
GraphFiveA <- gridExtra::grid.arrange(AgeSexOne, AgeSexTwo)
```
...
GraphFiveB <- gridExtra::grid.arrange(AgeSexOne, AgeSexTwo)
```
...
GraphFiveC <- gridExtra::grid.arrange(AgeSexOne, AgeSexTwo)
```
...
GraphFiveD <- gridExtra::grid.arrange(AgeSexOne, AgeSexTwo)
```
...
GraphFiveE <- gridExtra::grid.arrange(AgeSexOne, AgeSexTwo)
```

``` {r Graph Five Total}
gridExtra::grid.arrange(GraphFiveA, GraphFiveB,GraphFiveC,GraphFiveD,GraphFiveE)
```
...
- Trucks are involved in a significant number of accidents during morning and midday, but many truck accidents do not result in any injury.
...
- Trucks get in a significant number of accidents in the morning and midday which result in deaths at a heightened rate
...
- Men get in car accidents more frequently than women
